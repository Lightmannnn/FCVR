...
pretrain_default_model_kwargs = {
    'yolo': dict(ym_path=r'models/v8/model/yolov8m-seg.yaml'),
    # 'yolov8': dict(ym_path=r'models/v8/model/yolov8m-det.yaml'),
    # 'yolov8': dict(ym_path=r'models/v8/model/yolov8m-seg.yaml'),
    'resnet34': dict(drop_path_rate=0.01),
...
def build_encoder(name: str, input_size: int, sbn=False, drop_path_rate=0.0, verbose=False):
